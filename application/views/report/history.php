					...
					<div class="row">
						...
						<div class="col-lg-3 rounded  p-4" style="border-right: 2px solid; background: #19385b; ; color: white;">
							...
							<div class="row ">
								...
								<p class="card-text mx-1 m-1 text-warning"><?php echo $task->t_code; ?></p>
							</div>
							<div class="row ">
							...
							<div class="row ">
								...
								<p class="card-text mx-1 m-1 text-warning"><?php echo $task->given; ?></p>
							</div>
							<div class="row ">
							...
							<div class="row ">
								...
								<p class="card-text mx-2 m-1 text-warning"><?php echo date($this->config->item('date_format'), strtotime($task->end_date)); ?></p>
							</div>
							<div class="row ">
